        ...
        >
          <div ref={ref} className="h-fit p-6">
            ...
            <motion.div layout className="mt-8 flex justify-between">
              <Button
                className="h-8 w-fit rounded-full px-4 text-sm font-medium text-zinc-700 shadow-sm cursor-pointer"
              ...
              <Button
                className="relative h-8 w-fit rounded-full bg-gradient-to-b from-[#1994ff] to-[#157cff] px-5 text-sm font-medium text-white shadow-sm cursor-pointer"
