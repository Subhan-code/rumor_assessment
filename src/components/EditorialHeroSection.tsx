      ...
      <div className="flex items-center justify-between gap-3 pt-1 pb-0.5 md:hidden">
        ...
        {onOpenShare && (
          <button
            type="button"
            onClick={onOpenShare}
            className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-mono font-medium bg-[#E3DBC7]/[0.08] hover:bg-[#E3DBC7]/[0.16] border border-[#E3DBC7]/20 text-[#E3DBC7] transition-all cursor-pointer shrink-0"
            title="Share Event"
          >
            <svg
