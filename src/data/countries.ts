...
export const COUNTRIES: Country[] = [
  ...
  { name: 'Ascension Island', code: '+247', iso: 'AC', flag: '🇦🇨' },
  ...
  { name: 'Bermuda', code: '+1441', iso: 'BM', flag: '🇧🇲' },
  { name: 'Bhutan', code: '+975', iso: 'BT', flag: '🇧🇹' },
  { name: 'Bolivia', code: '+591', iso: 'BO', flag: '🇧🇴' },
  { name: 'Bonaire, Sint Eustatius and Saba', code: '+599', iso: 'BQ', flag: '🇧🇶' },
  { name: 'Bosnia and Herzegovina', code: '+387', iso: 'BA', flag: '🇧🇦' },
  { name: 'Botswana', code: '+267', iso: 'BW', flag: '🇧🇼' },
  { name: 'Brazil', code: '+55', iso: 'BR', flag: '🇧🇷' },
  { name: 'British Indian Ocean Territory', code: '+246', iso: 'IO', flag: '🇮🇴' },
  { name: 'Brunei Darussalam', code: '+673', iso: 'BN', flag: '🇧🇳' },
  ...
  { name: 'Cayman Islands', code: '+1345', iso: 'KY', flag: '🇰🇾' },
  ...
  { name: 'Dominican Republic', code: '+1809', iso: 'DO', flag: '🇩🇴' },
  ...
  { name: 'Federated States of Micronesia', code: '+691', iso: 'FM', flag: '🇫🇲' },
  ...
  { name: 'Guam', code: '+1671', iso: 'GU', flag: '🇬🇺' },
  { name: 'Guatemala', code: '+502', iso: 'GT', flag: '🇬🇹' },
  { name: 'Guernsey', code: '+44', iso: 'GG', flag: '🇬🇬' },
  ...
  { name: 'Holy See (Vatican City State)', code: '+379', iso: 'VA', flag: '🇻🇦' },
  ...
  { name: 'Isle of Man', code: '+44', iso: 'IM', flag: '🇮🇲' },
  ...
  { name: 'Jersey', code: '+44', iso: 'JE', flag: '🇯🇪' },
  ...
  { name: 'Macao', code: '+853', iso: 'MO', flag: '🇲🇴' },
  ...
  { name: 'Montserrat', code: '+1664', iso: 'MS', flag: '🇲🇸' },
  ...
  { name: 'Norfolk Island', code: '+672', iso: 'NF', flag: '🇳🇫' },
  { name: 'North Korea', code: '+850', iso: 'KP', flag: '🇰🇵' },
  { name: 'North Macedonia', code: '+389', iso: 'MK', flag: '🇲🇰' },
  { name: 'Northern Mariana Islands', code: '+1670', iso: 'MP', flag: '🇲🇵' },
  ...
  { name: 'Puerto Rico', code: '+1787', iso: 'PR', flag: '🇵🇷' },
  ...
  { name: 'Saint Barthélemy', code: '+590', iso: 'BL', flag: '🇧🇱' },
  ...
  { name: 'Saint Martin (French Part)', code: '+590', iso: 'MF', flag: '🇲🇫' },
  { name: 'Saint Pierre and Miquelon', code: '+508', iso: 'PM', flag: '🇵🇲' },
  { name: 'Saint Vincent and the Grenadines', code: '+1784', iso: 'VC', flag: '🇻🇨' },
  ...
  { name: 'Sint Maarten', code: '+1721', iso: 'SX', flag: '🇸🇽' },
  ...
  { name: 'Virgin Islands, British', code: '+1284', iso: 'VG', flag: '🇻🇬' },
  { name: 'Virgin Islands, U.S.', code: '+1340', iso: 'VI', flag: '🇻🇮' },
